...
function sqr(::Type{E}, a::T) where {T<:SysFloat, E<:Emphasis}
   return Double{T,E}(sqr_acc(a)...,)
end

function cub(::Type{E}, a::T) where {T<:SysFloat, E<:Emphasis}
   return Double{T,E}(cub_acc(a)...,)
end

function inv(::Type{E}, a::T) where {T<:SysFloat, E<:Emphasis}
   return Double{T,E}(inv_acc(a)...,)
end

function sqrt(::Type{E}, a::T) where {T<:SysFloat, E<:Emphasis}
...
@inline (/)(::Type{E}, a::F1, b::F2) where {E<:Emphasis, F1<:SysFloat, F2<:SysFloat} = (/)(E, promote(a, b)...) lo)
