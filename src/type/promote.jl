...
promote_rule(::Type{DoubleFloat{Float64}}, ::Type{T}) where {T<:Union{Base.BigInt,Base.BigFloat}} = DoubleFloat{Float64}
promote_rule(::Type{DoubleFloat{Float32}}, ::Type{T}) where {T<:Union{Base.BigInt,Base.BigFloat}} = DoubleFloat{Float32}
promote_rule(::Type{DoubleFloat{Float16}}, ::Type{T}) where {T<:Union{Base.BigInt,Base.BigFloat}} = DoubleFloat{Float16}
...
promote_rule(::Type{DoubleFloat{DoubleFloat{Float64}}}, ::Type{T}) where {T<:Union{Base.BigInt,Base.BigFloat}} = DoubleFloat{DoubleFloat{Float64}}
promote_rule(::Type{DoubleFloat{DoubleFloat{Float32}}}, ::Type{T}) where {T<:Union{Base.BigInt,Base.BigFloat}} = DoubleFloat{DoubleFloat{Float32}}
promote_rule(::Type{DoubleFloat{DoubleFloat{Float16}}}, ::Type{T}) where {T<:Union{Base.BigInt,Base.BigFloat}} = DoubleFloat{DoubleFloat{Float16}}
