...
maxintfloat(::Type{DoubleFloat{Float64}}) = DoubleFloat{Float64}(2.0^106, 2.0^53)
maxintfloat(::Type{DoubleFloat{Float32}}) = DoubleFloat{Float32}(2.0f0^48, 2.0f0^24)
maxintfloat(::Type{DoubleFloat{Float16}}) = DoubleFloat{Float16}(6.55e4, 15.0)
