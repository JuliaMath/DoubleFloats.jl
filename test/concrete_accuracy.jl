...
@test round(DoubleF64(123456.0, 1.0e-17), digits=RoundUp) == DoubleF64(123457.0, 0.0)
@test round(DoubleF64(123456.0, -1.0e-17), digits=RoundUp) == DoubleF64(123456.0, 0.0)
@test round(DoubleF64(123456.0, -1.0e-17), digits=RoundDown) == DoubleF64(123455.0, 0.0)
