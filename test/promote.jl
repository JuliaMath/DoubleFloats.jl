...
@testset "promote_rule" begin
  ...
  @test promote_rule(DoubleFloat{Float64}, BigInt) == BigInt
  @test promote_rule(DoubleFloat{Float32}, BigInt) == BigInt
  @test promote_rule(DoubleFloat{Float16}, BigInt) == BigInt
  @test promote_rule(BigInt, DoubleFloat{Float64}) == BigInt
  @test promote_rule(BigInt, DoubleFloat{Float32}) == BigInt
  @test promote_rule(BigInt, DoubleFloat{Float16}) == BigInt
