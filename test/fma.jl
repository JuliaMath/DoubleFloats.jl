@testset "fma" begin
  ...
  @test HILO(muladd(Float64(pi), Double64(phi), Float64(gamma))) == (5.660419357216792, 4.1838532153684e-16)
  @test HILO(muladd(Double64(pi), Float64(phi), Float64(gamma))) == (5.660419357216793, -2.7164108363986695e-16)
  @test HILO(muladd(Double64(pi), Double64(phi), Float64(gamma))) == (5.660419357216793, -2.7164108363986695e-16)
  @test HILO(muladd(Double64(pi), Float64(phi), Double64(gamma))) == (5.660419357216793, -2.765839987922976e-16)
  @test HILO(muladd(Double64(pi), Double64(phi), Double64(gamma))) == (5.660419357216793, -2.765839987922976e-16)
