...
@testset "rempi" begin
    ...
    @test DoubleFloats.remhalfpi(x) == Double64(1.3994169460904717, 9.363588222069835e-17)
    @test DoubleFloats.remqrtrpi(x) == Double64(0.6140187826930236, -4.8002590220501136e-17)
